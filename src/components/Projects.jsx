...
const projects = [
  {
    title: "MYKAS",
    description:
      "Aplikasi tabungan modern dengan Flutter & Supabase, menawarkan pengelolaan keuangan personal yang intuitif.",
    tags: ["Flutter", "Supabase", "Dart", "Firebase"],
  },
  {
    title: "GudangXC",
    description:
      "Sistem manajemen inventori dengan scanner QR Code, reporting real-time, dan dashboard analitik.",
    tags: ["React", "Supabase", "QR Code", "Tailwind"],
  },
  {
    title: "Portfolio Website",
    description:
      "Website portfolio modern dengan animasi smooth, optimasi performa, dan desain responsif.",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-light text-white mb-5">
            Proyek <span className="font-semibold text-white">Terpilih</span>
          </h2>

          <p className="text-zinc-400 max-w-2xl mx-auto text-lg">
            Kumpulan proyek terpilih yang menunjukkan keahlian dalam
        ...
        <div className="text-center mt-16 pt-10 border-t border-white/5">
          <p className="text-zinc-500 mb-6">
            Tertarik melihat lebih banyak proyek?
          </p>
          <a
